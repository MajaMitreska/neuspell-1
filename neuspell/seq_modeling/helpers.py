...
Original file is located at
    https://colab.research.google.com/drive/1-sy1USppHlVAHuCv7vRC54JQIvZcIGlh
"""
...
def bert_tokenize(batch_sentences):
    ...
    # batch_input_ids = pad_sequence([masking_reserved_words(RESERVED_WORDS, torch.tensor(encoded_dict["input_ids"])) for encoded_dict in batch_encoded_dicts], 
